...
|----|------|-----------------|
| 1  | [Prérequis](01-prerequis.md) | Les outils à installer **avant** de commencer (PHP, Node, PostgreSQL…) |
| 2  | [Installation en local](02-installation-locale.md) | Faire tourner le CRM sur **ton propre ordinateur** pour tester |
| 3  | [Le fichier de configuration `.env`](03-configuration.md) | Comprendre et remplir les réglages (base de données, e-mails, IA…) |
| 4  | [Héberger chez Hostinger](04-hebergement-hostinger.md) | Mettre le CRM en ligne sur un **VPS Hostinger** (contrôle total, coût maîtrisé) |
| 5  | [Héberger sans se prendre la tête](05-hebergement-simple.md) | La voie **la plus simple** : Laravel Cloud (officiel) ou Railway, sans serveur à configurer |
| 6  | [Dépannage (FAQ)](06-depannage.md) | Les erreurs fréquentes et comment les régler |
...
suivantes. Commence par [les prérequis](01-prerequis.md).
